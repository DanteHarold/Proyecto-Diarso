        ...
        <form action="<?php echo constant('URL') ?>productos/editarProducto" id="form-modal" class="form" method="POST">
            ...
            <div class="form__content">
                <div class="form__field">
                    ...
                    <input type="text" id="form-name"  name="name" value="<?php echo $this->producto->nombre; ?>" class="form__input">
                </div>
                <div class="form__field">
                    <label for="surname" class="form__label">Apellidos</label>
                    <input type="text" id="form-surname" name="surname" value="<?php echo $this->producto->apellido; ?>" required class="form__input">
                </div>
                <div class="form__field">
                    <label for="email" class="form__label">Correo</label>
                    <input type="email" id="form-email"  name="email" value="<?php echo $this->producto->email; ?>" required class="form__input">
                </div>
                <div class="form__field">
